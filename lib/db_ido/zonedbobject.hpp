...
private:
	static void UpdateConnectedStatus(const Zone::Ptr& zone);
	static int ZoneIsConnected(const Zone::Ptr& zone);
	static std::pair<bool, double> GetConnectionLag(const Zone::Ptr& zone);
};
